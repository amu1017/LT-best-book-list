...
- 最近注力していること
  - <span class="text-red-500 font-bold">Kubernetes</span>, ローカルLLM
...
- すごく運命的な出会いをした
  - ちょうど、業務でk8sを触ることになったタイミングだった
  - 新発売で本が出てconnpassで輪読会が開かれた

## 感想

- Linuxにこんなネットワークの機能があったのかと驚いた
  - 「Network Namespace」というOS内で通信を分離できる機能
  - コンテナのネットワーク分離の核となる機能
- ネットワーク図が直感的に理解できる
...
- R&Dという業務内容上、教科書通りのことしか触れない
  - k8sの"実際どう使われているか"が知りたかった
...
- 私と同じくインフラ出身でk8sに入門した人
  - ネットワークが得意であれば同じモヤモヤを感じるはずなので本①が役に立つ
  - 従来インフラにはなかったGit構成管理の文化を知りたいなら本②が役に立つ

<br><br>

- 「動くけど、なぜ動くかわからない」を解消したい人
  - 本①は"深さ"、本②は"広さ"を補える
